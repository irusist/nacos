...
set JAVA_DEBUG_OPT= -Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,address=7099,server=y,suspend=n
...
set "JAVA_OPT=%JAVA_OPT% %JAVA_DEBUG_OPT%"
